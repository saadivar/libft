...
CFILES= ft_atoi.c ft_isprint.c ft_memmove.c ft_strchr.c ft_strmapi.c ft_toupper.c ft_bzero.c ft_itoa.c \
		...
		ft_substr.c ft_isdigit.c ft_memcpy.c ft_split.c ft_strlen.c ft_tolower.c ft_lstnew.c ft_lstadd_front.c ft_lstsize.c \
